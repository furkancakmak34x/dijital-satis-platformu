...
namespace Uygulama
{
    public partial class FilmSatis : Form
    {
        ...
        {
            this.filmTableAdapter.Fill(this.dataset.Film);
            this.Icon = Properties.Resources.icon;
            lblFilm.Text = "Film Adı: " + dgFilm.CurrentRow.Cells[1].Value.ToString();
            lblAciklama.Text = "Film Açıklaması: " + dgFilm.CurrentRow.Cells[7].Value.ToString();
            pbCover.Image = Properties.Resources.oppenheimer;
        }

        private void btnEkle_Click(object sender, EventArgs e)
        {

            if (lstSepet.Items.Contains(dgFilm.CurrentRow.Cells[1].Value.ToString()))
            {
            ...
            {
                lstSepet.Items.Add(dgFilm.CurrentRow.Cells[1].Value.ToString());
                Fiyat += Convert.ToInt32(dgFilm.CurrentRow.Cells[6].Value);
        ...
        private void btnSil_Click(object sender, EventArgs e)
        {
            ...
            else if (lstSepet.SelectedItem.ToString() == "Oppenheimer")
            {
                Fiyat -= 399;
            }

            else if (lstSepet.SelectedItem.ToString() == "Labirent: Ölümcül Kaçış")
            {
                Fiyat -= 299;
            }

            else if (lstSepet.SelectedItem.ToString() == "Para Avcısı")
            {
                Fiyat -= 329;
            }

            else if (lstSepet.SelectedItem.ToString() == "The GodFather")
            {
                Fiyat -= 199;
            }

            else if (lstSepet.SelectedItem.ToString() == "The Banshees of Inisherin")
            {
                Fiyat -= 129;
            }
        ...
        private void dgFilm_Click(object sender, EventArgs e)
        {
            lblFilm.Text = "Film Adı: " + dgFilm.CurrentRow.Cells[1].Value.ToString();
            lblAciklama.Text = "Film Açıklaması: " + dgFilm.CurrentRow.Cells[7].Value.ToString();
            lstSepet.SelectedItem = dgFilm.SelectedRows[0];

            if (Convert.ToInt32(dgFilm.CurrentRow.Cells[0].Value) == 1)
            {
                pbCover.Image = Properties.Resources.oppenheimer;
            }

            else if (Convert.ToInt32(dgFilm.CurrentRow.Cells[0].Value) == 2)
            {
                pbCover.Image = Properties.Resources.labirent;
            }

            else if (Convert.ToInt32(dgFilm.CurrentRow.Cells[0].Value) == 3)
            {
                pbCover.Image = Properties.Resources.twows;
            }

            else if (Convert.ToInt32(dgFilm.CurrentRow.Cells[0].Value) == 4)
            {
                pbCover.Image = Properties.Resources.god;
            }

            else if (Convert.ToInt32(dgFilm.CurrentRow.Cells[0].Value) == 5)
            {
                pbCover.Image = Properties.Resources.tboi;
            }
        }
